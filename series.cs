...
namespace popa
{
    public class popa_dz
    {
        ...
        public static double[] Series16(int B)
        {
             B = 120;
            int N = 5, minIndex=0;
        ...
        private static void Series23()
        {
            int N = 6, counter = 0;
            int[] a = new int[] { 35, 74, 33, 82, 91, 5 };
